...
class Asset(Base):
    ...
    license_type: Mapped[str] = mapped_column(Text, nullable=True)        # CC0, royalty-free, etc.
    source_provider: Mapped[str] = mapped_column(Text, nullable=True)     # pexels | pixabay | freesound
