        ...
        <section className="mt-28">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 text-left">
            ...
            >
              ...
              <h3 className="text-base font-bold mb-2" style={{ color: 'var(--t-text-1)' }}>Costume & Wardrobe Studio</h3>
              <p className="text-sm leading-relaxed" style={{ color: 'var(--t-text-3)' }}>
                Multi-budget costume plans (Indie, Mid, Studio), itemized character wardrobe costs, and sourcing strategy.
              </p>
            </div>
          </div>
        </section>
